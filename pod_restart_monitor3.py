...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('/tmp/pod_restart_monitor.log'),
...
class KubernetesPodMonitor:
    ...
    def load_previous_state(self):
        ...
        state_file = self.config.get('state_file', '/tmp/k8s_monitor_state.json')
        try:
    ...
    def save_alerts_to_csv(self, filename: str = "/tmp/restart_alerts.csv"):
    ...
    def save_detailed_alerts_to_json(self, filename: str = "/tmp/restart_alerts_detailed.json"):
    ...
    def save_statistics_to_json(self, filename: str = "/tmp/monitoring_statistics.json"):
...
def main():
    ...
    parser.add_argument('--output-csv', default='/tmp/restart_alerts.csv',
                       help='CSV output file path')
    parser.add_argument('--output-json', default='/tmp/restart_alerts_detailed.json',
                       help='JSON output file path')
    parser.add_argument('--stats-json', default='/tmp/monitoring_statistics.json',
